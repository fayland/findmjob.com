...
sub run {
    ...
    foreach my $item (@{ $data->{Results}->{JobSearchResult} }) {
        ...
        unless (@tags) {
            ...
            my @bad_industries = ('Restaurant - Food Service', 'Retail', 'Real Estate', 'Automotive', 'Other', 'Skilled Labor - Trades', 'Transportation', 'Admin - Clerical', 'Health Care', 'Nurse', 'Professional Services', 'Accounting');
