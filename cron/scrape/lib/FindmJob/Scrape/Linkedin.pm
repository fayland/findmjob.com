...
sub run {
    ...
    foreach my $r (@{$data->{jobs}->{values}}) {
        ...
        unless (@tags) {
            my @bad_industries = ('Financial Services', 'Transportation/Trucking/Railroad', 'Hospital & Health Care', 'Pharmaceuticals', 'Biotechnology', 'Electrical/Electronic Manufacturing', 'Airlines/Aviation', 'Machinery', 'Chemicals', 'Industrial Automation', 'Food Production', 'Accounting', 'Real Estate', 'Wine and Spirits', 'Renewables & Environment', 'Health, Wellness and Fitness', 'Consumer Goods', 'Apparel & Fashion', 'Environmental Services', 'Mechanical or Industrial Engineering', 'Oil & Energy', 'Automotive', 'Venture Capital & Private Equity', 'Consumer Services', 'Think Tanks', 'Higher Education', 'Retail', 'Construction', 'Sports', 'Hospitality', 'Marketing and Advertising', 'Medical Devices', 'Dairy', 'Banking', 'Architecture & Planning', 'Civil Engineering', 'Insurance');
